...
async function analyzeForAimlFix(
  ...
  const system = `You are a knowledge-base engineer for Brass Note Studios, a bespoke songwriting and production atelier. You maintain an AIML 2.0 chatbot called the Atelier Concierge.
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    if (aimlDocument) {
      const body = `> **Auto-generated by BNSignal Concierge Analyzer**
